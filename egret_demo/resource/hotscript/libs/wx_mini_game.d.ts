...
declare const wx: {
    env: any;
    createBannerAd(object: { adUnitId: string, style: any }): any;
    createRewardedVideoAd(object: { adUnitId: string }): any;
    createUserInfoButton(object: { type: string, text: string, image: string, style: any, withCredentials?: boolean, lang?: string }): any;
    /**
     ...
     * 创建投诉按钮
     */
    createFeedbackButton(object: { type: string, text?: string, image?: string, style?: any }): any;
    /**
     * 创建一个图片对象
     */
    createImage(): Image;
     ...
     */
    getUserInfo(object: { withCredentials?: boolean, openIdList?: any[], lang?: string, success?: (res: any) => void, fail?: (res: any) => void, complete?: (res: any) => void }): void;
     ...
     */
    onShareAppMessage(callback: (res: any) => void): void;
    /**
    ...
    */
    ...
    aldOnShareAppMessage(callback: (res: any) => void): void;
...
declare interface Canvas {
     ...
     */
    toTempFilePathSync(object: { x?: number, y?: number, width?: number, height?: number, destWidth?: number, destHeight?: number, fileType?: string, quality?: number }): string;
}
